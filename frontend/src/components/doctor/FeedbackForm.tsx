    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15h2.25m8.024-9.75c.011.05.028.1.046.148.118.4-.023.838-.318 1.158a9.04 9.04 0 01-2.861 2.4c-.723.384-1.35.956-1.653 1.715a4.498 4.498 0 00-.322 1.672V21a.75.75 0 01-.75.75 2.25 2.25 0 01-2.25-2.25c0-1.152.26-2.243.723-3.218.266-.558-.107-1.282-.725-1.282H3.622c-1.026 0-1.945-.694-2.054-1.715A12.137 12.137 0 011.5 12c0-2.848.992-5.464 2.649-7.521.388-.482.987-.729 1.605-.729h4.616c.483 0 .964.078 1.423.23l3.114 1.04c.459.152.94.23 1.423.23h.904M14.25 15h2.25m-2.25 0a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" /></svg>
            Thumbs Down
          </button>
        </div>
      </div>
